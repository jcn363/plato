...
impl Reader {
    ...
    /* NOTE: settings_manager module removed - menu creation disabled
    ...
    pub fn show_settings_menu(
        ...
        // Settings manager module removed during dead code cleanup
        let _ = (rect, rq, context);
    }
    */
    ...
    pub fn toggle_line_height_menu(
        &mut self,
        rect: Rectangle,
        enable: Option<bool>,
        rq: &mut RenderQueue,
    ...
    pub fn toggle_contrast_exponent_menu(
        &mut self,
        rect: Rectangle,
        enable: Option<bool>,
        rq: &mut RenderQueue,
    ...
    pub fn toggle_contrast_gray_menu(
        &mut self,
        rect: Rectangle,
        enable: Option<bool>,
        rq: &mut RenderQueue,
    ...
    pub fn toggle_margin_width_menu(
        &mut self,
        rect: Rectangle,
        enable: Option<bool>,
        rq: &mut RenderQueue,
    ...
    pub fn toggle_margin_cropper_menu(
        &mut self,
        rect: Rectangle,
        enable: Option<bool>,
        rq: &mut RenderQueue,
