...
#[allow(dead_code)] // Used for margin cropper UI button sizing
pub const BUTTON_DIAMETER: f32 = 40.0;

#[allow(dead_code)] // Used for PDF margin cropping interface
...
#[allow(dead_code)] // Margin cropping UI implementation
impl MarginCropper {
    pub fn new(
        rect: Rectangle,
        pixmap: Pixmap,
