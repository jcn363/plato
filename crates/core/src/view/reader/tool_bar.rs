...
impl ToolBar {
    pub fn new(
        ...
        if reflowable {
            ...
            // First row.
            let contrast_icon_rect =
                rect![rect.min.x, rect.min.y, rect.min.x + side, rect.min.y + side];
