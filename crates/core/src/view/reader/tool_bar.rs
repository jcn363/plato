...
impl ToolBar {
    ...
    /// Toolbar update method for margin width setting
    ...
    /// Toolbar update method for font size slider
    ...
    /// Toolbar update method for contrast exponent slider
    ...
    /// Toolbar update method for contrast gray slider
