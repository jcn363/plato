...
impl EntryId {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            EntryId::CoverRotate90 => "CoverRotate90",
            EntryId::CoverRotate180 => "CoverRotate180",
            EntryId::CoverRotate270 => "CoverRotate270",
            EntryId::CoverGrayscale => "CoverGrayscale",
            EntryId::CoverCrop => "CoverCrop",
            EntryId::CoverBrightness(_) => "CoverBrightness",
            EntryId::CoverContrast(_) => "CoverContrast",
            EntryId::CoverSave => "CoverSave",
            EntryId::Back => "Back",
