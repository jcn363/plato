...
impl Default for MxcfbRect {
    fn default() -> Self {
        // SAFETY: MxcfbRect is a repr(C) struct with only integer fields; zeroed memory is valid.
        unsafe { mem::zeroed() }
    }
}
...
pub const NTX_WFM_MODE_GCK16: u32 = 8;
pub const NTX_WFM_MODE_GLKW16: u32 = 9;
