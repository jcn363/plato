...
BUILD_DIR=$PROJECT_ROOT/target/jbig2dec/iOS/arm64
mkdir -p $BUILD_DIR
...
BUILD_DIR=$PROJECT_ROOT/target/jbig2dec/iOS-sim/arm64
mkdir -p $BUILD_DIR
...
BUILD_DIR=$PROJECT_ROOT/target/jbig2dec/iOS-sim/x86_64
mkdir -p $BUILD_DIR
...
mkdir -p $PROJECT_ROOT/target/jbig2dec/iOS-device/lib
mkdir -p $PROJECT_ROOT/target/jbig2dec/iOS-simulator/lib
lipo -create \
  $PROJECT_ROOT/target/jbig2dec/iOS-sim/arm64/lib/libjbig2dec.a \
  $PROJECT_ROOT/target/jbig2dec/iOS-sim/x86_64/lib/libjbig2dec.a \
  -output $PROJECT_ROOT/target/jbig2dec/iOS-simulator/lib/libjbig2dec.a || echo "Some simulator architectures may have failed"
cp $PROJECT_ROOT/target/jbig2dec/iOS/arm64/lib/libjbig2dec.a $PROJECT_ROOT/target/jbig2dec/iOS-device/lib/
