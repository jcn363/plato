...
BUILD_DIR=../target/gumbo/iOS/arm64
mkdir -p $BUILD_DIR
cd $BUILD_DIR
...
cmake ../../../thirdparty/gumbo -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=$(pwd) -DCMAKE_OSX_ARCHITECTURES=arm64 -DCMAKE_OSX_SYSROOT=$IOS_SDK -DBUILD_SHARED_LIBS=OFF
make clean || true
...
BUILD_DIR=../target/gumbo/iOS-sim/arm64
mkdir -p $BUILD_DIR
cd $BUILD_DIR
...
cmake ../../../thirdparty/gumbo -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=$(pwd) -DCMAKE_OSX_ARCHITECTURES=arm64 -DCMAKE_OSX_SYSROOT=$IOS_SIM_SDK -DBUILD_SHARED_LIBS=OFF
make clean || true
make -j$(sysctl -n hw.ncpu)
cd ../../..
...
BUILD_DIR=../target/gumbo/iOS-sim/x86_64
mkdir -p $BUILD_DIR
cd $BUILD_DIR
...
cmake ../../../thirdparty/gumbo -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=$(pwd) -DCMAKE_OSX_ARCHITECTURES=x86_64 -DCMAKE_OSX_SYSROOT=$IOS_SIM_SDK -DBUILD_SHARED_LIBS=OFF
make clean || true
make -j$(sysctl -n hw.ncpu)
cd ../../..
