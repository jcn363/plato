...
BUILD_DIR=$PROJECT_ROOT/target/libjpeg/iOS/arm64
mkdir -p $BUILD_DIR
...
BUILD_DIR=$PROJECT_ROOT/target/libjpeg/iOS-sim/arm64
mkdir -p $BUILD_DIR
...
BUILD_DIR=$PROJECT_ROOT/target/libjpeg/iOS-sim/x86_64
mkdir -p $BUILD_DIR
...
mkdir -p $PROJECT_ROOT/target/libjpeg/iOS-device/lib
mkdir -p $PROJECT_ROOT/target/libjpeg/iOS-simulator/lib
lipo -create \
  $PROJECT_ROOT/target/libjpeg/iOS-sim/arm64/lib/libjpeg.a \
  $PROJECT_ROOT/target/libjpeg/iOS-sim/x86_64/lib/libjpeg.a \
  -output $PROJECT_ROOT/target/libjpeg/iOS-simulator/lib/libjpeg.a || echo "Some simulator architectures may have failed"
cp $PROJECT_ROOT/target/libjpeg/iOS/arm64/lib/libjpeg.a $PROJECT_ROOT/target/libjpeg/iOS-device/lib/
