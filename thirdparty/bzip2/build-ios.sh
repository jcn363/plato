...
BUILD_DIR=$PROJECT_ROOT/target/bzip2/iOS/arm64
...
BUILD_DIR=$PROJECT_ROOT/target/bzip2/iOS-sim/arm64
mkdir -p $BUILD_DIR/lib
...
BUILD_DIR=$PROJECT_ROOT/target/bzip2/iOS-sim/x86_64
mkdir -p $BUILD_DIR/lib
...
mkdir -p $PROJECT_ROOT/target/bzip2/iOS-device/lib
mkdir -p $PROJECT_ROOT/target/bzip2/iOS-simulator/lib
lipo -create \
  $PROJECT_ROOT/target/bzip2/iOS-sim/arm64/lib/libbz2.a \
  $PROJECT_ROOT/target/bzip2/iOS-sim/x86_64/lib/libbz2.a \
  -output $PROJECT_ROOT/target/bzip2/iOS-simulator/lib/libbz2.a || echo "Some simulator architectures may have failed"
cp $PROJECT_ROOT/target/bzip2/iOS/arm64/lib/libbz2.a $PROJECT_ROOT/target/bzip2/iOS-device/lib/
